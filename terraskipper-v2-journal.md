...
- Exported at: 2026-06-20T03:03:52Z
- Project ID: 3356
- Entries: 24
...
- ID: 13090
- Author: Ziad
- Created At: 2026-06-10T20:16:08Z

### Content

I started by looking at the comments and decided to focus first on improving the overall shape and appearance of the PCB. Before making any changes I searched for some tutorials and examples of professional PCB designs to understand what makes a PCB look cleaner and more polished.

After watching a few toturials I started applying some of the ideas to my own design. The main change was rounding the corners of the PCB instead of keeping them sharp. This made the board look more professional and also more practical for manufacturing and handling.

I also spent some time trying to organize and polish the PCB layout by checking the overall shape and making small improvements based on what I learned from the tutorials. Most of the session was spent comparing different approaches and testing changes to get the best result possible.

By the end of the session I finished the first round of PCB improvements and had a cleaner and more polished design than before.
![Screenshot 2026-06-10 231245.png](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzA4NDEsInB1ciI6ImJsb2JfaWQifX0=--07f38c3be4c0f845094a07bd1e9ee5d2130b0530/Screenshot 2026-06-10 231245.png)


### Recording Links

- https://lookout.hackclub.com/api/media/7e9f44e7-c6f1-4fb7-ab61-6f889f83fdfa/video.mp4

## Entry 20
- ID: 13109
- Author: Ziad
- Created At: 2026-06-10T22:36:41Z

### Content

I polished the layout more and made some final adjustments to improve the overall look and organization of the board. I also added mounting holes for screws so the PCB can be secured properly inside the robot instead of just being placed freely.

After finishing the PCB changes I moved to the 3d model and started making a dedicated place for mounting the PCB inside the body. I adjusted the design so the board can fit properly and be attached using the screw holes that I added earlier.

Then I worked on the sensor placement mechanism and added the sensors to the assembly. This helped me check if the sensors actually fit in the available space and if the placement mechanism can hold them correctly. I also checked the overall arrangement to make sure there are no collisions between the sensors and other parts of the robot.
![17.png](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzA5MjIsInB1ciI6ImJsb2JfaWQifX0=--7023aba59fe92a5e734a684076e3940a253de09e/17.png)
![3d.png](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzA5MjMsInB1ciI6ImJsb2JfaWQifX0=--3b55b9a42b82f81696086094a7b37e52a8dcfb86/3d.png)


### Recording Links

- https://lookout.hackclub.com/api/media/e589412c-988f-4afd-a635-bbef81031417/video.mp4

## Entry 21
- ID: 13607
- Author: Ziad
- Created At: 2026-06-13T01:44:59Z

### Content

I started by collecting all the componets and rebuilding the circuit based on the latest schematic. Since this was the first full physical setup I connected everything step by step instead of connecting all at once to make debugging easier.

I started with the power section and made sure the voltages going to each component were correct before connecting sensors and modules. After that I connected the Raspberry Pi Pico 2 W and checked that it powers correctly and can communicate with the sensors.

Then I connected the soil sensors. I connected the soil moisture sensor and tested if the values change depending on the environment and checked that the readings are reaching the Pico correctly. After that I connected the TDS sensor and tested the output values and signal reading. Since both sensors are important for measuring soil conditions I spent time making sure the values are stable and the wiring is correct.

After finishing that I worked on the temperature sensor. Since the sensor requires additional support in the circuit I added a resistor to make the readings more stable and connected it according to the required configuration. I tested different readings and checked if the values respond correctly.

Then I moved to the ultrasonic sensors. Since the robot uses 3 ultrasonic sensors for movement and obstacle detection I connected each one seperately and tested them one by one before testing them together. I checked the trigger and echo pins and made sure each sensor gives correct distance values without interfering with the others. This part took some time because I wanted to confirm that all three sensors can work together correctly.

After connecting all the sensors I started testing the whole circuit together. I uploaded simple test code and checked each sensor output one by one to make sure everything responds correctly with the Pico. Whenever something didnt work I checked the connections and wiring again and corrected mistakes until the readings became stable.

Most of the session was spent building testing reconnecting and verifying each component because I wanted to make sure the hardware actually works before moving to the next stage.
![Screenshot 2026-06-13 044050.png](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzIyMzksInB1ciI6ImJsb2JfaWQifX0=--87086383eee2441322cf838efd7f49427386b2aa/Screenshot 2026-06-13 044050.png)


### Recording Links

- https://lookout.hackclub.com/api/media/d204cdf8-8fbc-4f17-bd24-da495978f0f2/video.mp4

## Entry 22
- ID: 13841
- Author: Ziad
- Created At: 2026-06-13T23:45:59Z

### Content

I started by preparing all the printed and designed parts and began assembling the robot from the main body. Since the body was designed in two seperate parts because of printing limitations and to reduce material usage I started by joining both body sections together and checking that the dimensions still align correctly after printing and assembly. I made small adjustments while assembling to make sure there are no gaps and that the structure feels stable.

After finishing the body assembly I moved to the sensor placement mechanism. I assembled the linear movement system and attached the holder and the pusher that was designed before. Then I mounted the sensors on their designed positions and checked that the mechanism still moves correctly up and down and that the sensors do not collide with the body during movement.

Then I started installing the motors. I mounted the DC motors in their holders and connected them to the body. After that I assembled the pectrol fins and connected them to the motors using the couplers and rods that were designed before. I checked the movement manually to make sure the fins rotate smoothly and dont hit the body. Then I installed the servo motor for the claudel fin and mounted the fin directly on it and tested its movement range.

After finishing the movement system I moved to installing the circuit inside the body. I placed the assembled circuit in the PCB holder and secured it in its position. Then I connected the different sensors and modules to the Pico 2 W and started organizing the wires inside the body. This part took alot of time because there were many connections and I wanted to keep the wiring clean and avoid putting stress on the connectors.

After the full assembly was finished I started testing again. I first tested the power system and checked that every component receives power correctly. Then I tested the sensors one by one including the soil moisture sensor the TDS sensor the temperature sensor and the ultrasonic sensors to make sure they still work after assembly.

After sensor testing I tested the movement system. I checked the DC motors and the fins movement then tested the sensor placement mechanism movement. During testing I found some small issues like wires affecting movement and some parts needing repositioning so I adjusted and tested again.

The rest of the session was mostly repeated testing small modifications reconnecting and making sure the whole prototype works as one system instead of seperate parts.
![IMG_1817.jpg](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzI4NTcsInB1ciI6ImJsb2JfaWQifX0=--3669e621e05beb86f91268f59d2ba60afb1c2446/IMG_1817.jpg)
![WhatsApp Image 2026-06-14 at 2.44.53 AM.jpeg](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzI4NjEsInB1ciI6ImJsb2JfaWQifX0=--f861e19787f9b14b4dfba96bb2879a8c03042fa6/WhatsApp Image 2026-06-14 at 2.44.53 AM.jpeg)
![WhatsApp Image 2026-06-14 at 2.44.51 AM.jpeg](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzI4NjIsInB1ciI6ImJsb2JfaWQifX0=--cadbdbce36626e5cce336757dbae40facb94344d/WhatsApp Image 2026-06-14 at 2.44.51 AM.jpeg)


### Recording Links

- https://lookout.hackclub.com/api/media/66148697-d1cb-4e10-8248-9b0e806a1c4e/video.mp4

## Entry 23
- ID: 14122
- Author: Ziad
- Created At: 2026-06-15T00:01:46Z

### Content

After finishing the assembly from the previous session I started uploading and applying the code to the robot and testing each function one by one. Most of the session was repeated testing changing values fixing errors then uploading the code again. Since this was one of the first times running the full system together there were alot of small issues that only appeared after real testing.

I kept modifying parts of the algorithm and retesting until I got the behavior I wanted. During the movement testing I noticed that the right DC motor that holds the fin was not moving at all. At first I thought that the motor itself might be burned or damaged.

To test that idea I removed both DC motors and swapped their positions. After doing that I found that the motor that wasnt working started moving normally while the other side stopped moving instead. This showed that the problem was probably not from the motor itself.

After finding that I shifted my focus to the motor driver and started suspecting that the issue was coming from there especially on motor B output. I repeated the tests multiple times checked the wiring uploaded test code again and tried different values but I still couldnt get the second output to work correctly.

Since I couldnt fully solve it during this session I decided not to spend more time on it and continued testing the rest of the algorithm and systems that were still functioning. I finished checking the remaining logic and made sure the other parts still respond correctly.
![IMG_1822.jpg](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzM1NjcsInB1ciI6ImJsb2JfaWQifX0=--3eae6ebc5253ef77d8749023c973905c2de089ba/IMG_1822.jpg)
![WhatsApp Image 2026-06-14 at 2.44.50 AM.jpeg](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzM1NjgsInB1ciI6ImJsb2JfaWQifX0=--8a0535c94f2b857d2f52b277f5060b1eace83c2a/WhatsApp Image 2026-06-14 at 2.44.50 AM.jpeg)


### Recording Links

- https://lookout.hackclub.com/api/media/faef36a0-ccbc-4dd4-b114-9fda6303d759/video.mp4

## Entry 24
- ID: 15265
- Author: Ziad
- Created At: 2026-06-19T15:36:19Z

### Content

I started by checking the whole prototype and making sure everything is assembled correctly and nothing became loose after the previous testing sessions. I checked the body connections motors fins sensor placement mechanism and the circuit to make sure everything still works before recording.

After that I organized the wiring inside the robot because some wires were affecting movement and also didnt look clean for the video. I adjusted and secured the connections so the prototype looks more organized and closer to the final version.

Then I powered the robot and started doing quick tests for the sensors and movement to make sure everything responds correctly before filming. I tested the movement of the fins the sensor placement mechanism and checked that the code still uploads and runs correctly.

I also spent some time preparing the testing area and thinking about how to show the different features clearly in the video. I repeated some movements and small tests multiple times to make sure they look smooth and understandable.




![Screenshot 2026-06-19 183553.png](/user-attachments/blobs/redirect/eyJfcmFpbHMiOnsiZGF0YSI6MzYzNzYsInB1ciI6ImJsb2JfaWQifX0=--0b3b140c5ac379906494d33d7fa53b518e519ba8/Screenshot 2026-06-19 183553.png)


### Recording Links

- https://lookout.hackclub.com/api/media/275ba971-c6dc-4c9a-89bd-eef1457d5288/video.mp4
